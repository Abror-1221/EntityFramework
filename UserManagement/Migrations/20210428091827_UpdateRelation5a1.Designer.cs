...
namespace UserManagement.Migrations
{
    ...
    [Migration("20210428091827_UpdateRelation5a1")]
    partial class UpdateRelation5a1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserManagement.Models.Accounts", b =>
                {
                    b.HasOne("UserManagement.Models.Profilings", "Profiling")
                        .WithOne("Account")
            ...
            modelBuilder.Entity("UserManagement.Models.Persons", b =>
                {
                    b.HasOne("UserManagement.Models.Accounts", "Account")
                        .WithOne("Person")
                        .HasForeignKey("UserManagement.Models.Persons", "NIK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
